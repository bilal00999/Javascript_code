...
//* Methods:
//* =================================
//? Methods in objects are functions associated with the object. They can be invoked using the same notation 
// as properties:
...
// let student = {
//   [`idType${1}`]: "A123456", // Dynamic key based on idType
//   [`idType${2}`]:"cosc231101023",
//   sName: "Vinod",
//   sAge: 29,
//   isStudent: true,
//   greet: function () {
...
// Objects are excellent for modeling real-world entities. For instance, you might represent a car,
// a user, or a product as an object with properties like color, brand, username, etc.
...
//! Explain the difference between passing objects by reference and by value in JavaScript. Provide 
// an example to demonstrate each scenario.

//? sol: In JavaScript, primitive data types like numbers and strings are passed by value, while objects are
//  passed by reference.
...
//? Passing by reference: When passing by reference, a reference to the memory location of the object is 
// passed to the function or assigned to a variable. Any changes made to the object through this reference
...
//* In this example, the greet method is defined using the "Method Shorthand" syntax. It's a more 
// concise way to define methods in object literals.
const obj = {
  name: "Kodyfier",
  greet() {
    console.log(this);
...
//? 3: Object.entries(): Returns an array containing arrays of key-value pairs for each enumerable own 
// property of an object.

//? 4: Object.hasOwnProperty(): Returns a boolean indicating whether the object has the specified 
// property as an own property.
...
//* ================================================
//! Problem: Write a function that compares two objects to determine if they have the same properties 
// and values.
...
//* ================================================
//! Problem: Write a function that transforms an array of an objects into an object where the keys are
//  the objects' ids.
